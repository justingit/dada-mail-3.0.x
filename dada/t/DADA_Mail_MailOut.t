...
# Perhaps attempt to pole that file directly...
#diag(q{DADA::Mail::MailOut::_poll($undef_counter_mailout->dir . '/' . 'counter.txt') } . DADA::Mail::MailOut::_poll($undef_counter_mailout->dir . '/' . 'counter.txt')); 
