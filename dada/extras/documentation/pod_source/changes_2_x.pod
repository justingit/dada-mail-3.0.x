...
=head3 Multiple Subscriber Fields
...
=item * Mail Merging of subscriber fields

=item * Partial Sending based on subscriber fields
...
http://dadam
ailproject.com/support/documentation/FAQ-email_sending.pod.html
...
=item * 1529990  	  2.10.9 - "Send a List Message" still available, even when...
...
Message, Send a List Message -> Advanced and the Send a
...
=item *  1528774  	  2.10.9 - pod mangled in error_faq.pod "The only other"...
...
http://dadamailproject.com/support/documentation/faq.pod.html#what_s_the_differences_between_the_two_smtp_engines
...
=item * Send a List Message -> Advanced
...
=item *1373261 	2.10.2 - Incorrect information in UPGRADE_README.pod
...
=item  1213101 	2.9.1 - "Send a List Message" Subject textfield...
...
=item * [ 963425 ] 2.8.13 - missing information on adv send a list message screen
...
=item * Send a list message screen allows you to open a new window on submit

=item * send a list message screen now has "are you sure?" checkbox
...
=for html <p>For More Information, please see <a href="mojo_to_dada.pod.html">Upgrading Dada Mail from Mojo Mail 2.8.9 and below
...
When in the advanced Send a List Message screen, messages were still being archived, even if you've unchecked, "Archive Message". This has been B<fixed>. 
...
=item * Send A List Message->Advanced screen

Fixed a bad link in the I<Send A list Message -> Advanced...>, the link, labeled, "Basic...", wasn't going anywhere interesting. 
...
Some people were reporting that the "Send a List Message" screen would hang after they submitted the form. This has been B<fixed> by reopening STDIN and STDOUT to a null device, as suggested: 
...
source fairly well. If it works out well, I'll do the same for archived plaintext messages, when they're viewed via a browser, and have this an option (plain text to HTML) in the basic, "Send a List Message" screen and who knows what else. I think Plaintext to HTML could be used in a million places. 
...
not from the send a list message form. That's alot of stuff. 
