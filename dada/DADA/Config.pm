...
$HELP_LINKS_URL ||= 'http://dadamailproject.com/pro_dada/3.0.0';
...
# Sending Options 
	...
	# A somewhat secret configuration, see the, 
	# "Dada Mail Hacks" board at: 
	# http://dadamailproject.com/support/boards/viewtopic.php?f=18&t=602
	#
